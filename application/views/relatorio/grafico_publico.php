...
<!--                    gráfico de pizza-->
                    <div class="col-sm-6">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="chart-area"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                    <canvas id="porcentagem_desperdicio"  style="display: block; width: 273px; height: 220px;" width="273" height="120" class="chartjs-size-monitor-expand"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--                    gráfico de área - linhas-->
                    <div class="col-lg-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="chart-area"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                    <canvas id="peso_desperdicado" style="display: block; width: 273px; height: 220px;" width="273" height="120" class="chartjs-size-monitor-expand"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
