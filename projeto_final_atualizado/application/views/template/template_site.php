...
<meta name="theme-color" content="#563d7c">
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-success">
      <a class="navbar-brand" href="#"><img src="<?= base_url("bootstrap/img/logo.png") ?>" class="img-logo"></a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarCollapse" ar>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item <?php echo ($this->router->class == "relatorio") ? "active" : ""?>">
          <a class="nav-link" href="<?= site_url("relatorio/index")?>">Relatório</a>
        </li>
        <li class="nav-item <?php echo ($this->router->class == "servicos") ? "active" : ""?>">
            <a class="nav-link" href="<?= site_url("servicos/index")?>">Serviços</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">Sobre</a>
        </li>
        <li class="nav-item <?php echo ($this->router->class == "login") ? "active" : ""?>">
          <a class="nav-link" href="<?= site_url("login/index")?>">Área restrita</a>
        </li>
        <li class="nav-item">
      ...
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption text-right">
                ...
                <img class="bd-placeholder-img" src="<?= base_url("bootstrap/img/fome-principal.jpg")?>" width="61%" height="5%">
      ...
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption text-right">
                ...
                <img class="bd-placeholder-img" src="<?= base_url("bootstrap/img/rest.jpg")?>" width="65%" height="5%">
...
<!--        Imagem 3-->
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption text-right">
              <div class="borda-img">
                <img class="bd-placeholder-img" src="<?= base_url("bootstrap/img/logo2.jpg")?>" width="65%" height="2%">
              </div>
