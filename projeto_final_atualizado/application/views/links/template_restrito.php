    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item <?= ($this->router->class == "cardapio") ? "active" : ""?>">
          <a class="nav-link" href="<?= site_url("cardapio/index") ?>">Cardapio</a>
        </li>
        <li class="nav-item <?= ($this->router->class == "refeicao") ? "active" : ""?>">
          <a class="nav-link" href="<?= site_url("refeicao/index") ?>">Refeicao</a>
        </li>
        <li class="nav-item <?= ($this->router->class == "desperdicio") ? "active" : ""?>">
          <a class="nav-link" href="<?= site_url("desperdicio/index") ?>">Desperdicio</a>
        </li>
        <li class="nav-item <?= ($this->router->class == "user") ? "active" : ""?>">
          <a class="nav-link" href="<?= site_url("user/index") ?>">Usuario</a>
        </li>
